...
# Minimum-length-only pattern used when TESTING=true to allow obviously-fake test passwords
# (e.g. 'not-real-password') without weakening production complexity requirements.
_TEST_PASSWORD_PATTERN = re.compile(r'^.{8,}$')
